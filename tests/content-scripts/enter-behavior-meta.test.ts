...
describe("enter-behavior-meta", () => {
  afterEach(() => {
    resetEnterBehaviorGlobals();
  });

  it("inserts a newline into the textarea on Shift+Enter", async () => {
    await setupProvider(["enter-behavior-utils.js", "enter-behavior-meta.js"], "default");
    const textarea = seedFocusedTextarea("hi");
