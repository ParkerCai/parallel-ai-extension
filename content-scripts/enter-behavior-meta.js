// Meta AI Enter/Shift+Enter behavior swap.
  ...
  return Boolean(
    isContentEditable &&
      ...
      (element.closest("form") ||
        ...
        element.getAttribute("aria-label")?.toLowerCase().includes("ask")),
  );
}
