...
(function() {
  ...
  const SAVE_TOOLTIP_TEXT = {
    'en': 'Save this conversation to Parallel AI',
    'zh_CN': '保存此对话到 Parallel AI',
    'zh_TW': '保存此對話到 Parallel AI',
    'ja': 'この会話を Parallel AI に保存',
    'ko': '이 대화를 Parallel AI에 저장',
    'ru': 'Сохранить этот разговор в Parallel AI',
    'es': 'Guardar esta conversación en Parallel AI',
    'fr': 'Enregistrer cette conversation dans Parallel AI',
    'de': 'Dieses Gespräch in Parallel AI speichern',
    'it': 'Salva questa conversazione su Parallel AI'
  };
